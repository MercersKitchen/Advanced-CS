...
public void greyscale(){
  ...
  {
    for(Pixel pixelObj : rowArray){
      int Red = ((pixelObj.getRed()+pixelObj.getGreen()+pixelObj.getBlue())/3);
      int Green = ((pixelObj.getRed()+pixelObj.getGreen()+pixelObj.getBlue())/3);
      int Blue = ((pixelObj.getRed()+pixelObj.getGreen()+pixelObj.getBlue())/3);
      pixelObj.setRed(Red);
